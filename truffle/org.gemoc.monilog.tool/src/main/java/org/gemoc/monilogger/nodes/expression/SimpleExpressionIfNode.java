...
public abstract class SimpleExpressionIfNode extends SimpleExpressionNode {
	...
	protected SimpleExpressionIfNode(SimpleExpressionNode left, SimpleExpressionNode right) {
		this.thenNode = left;
		this.elseNode = right;
	}
