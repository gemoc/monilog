...
public class MoniLoggerStreamAppenderNode extends MoniLoggerExecutableNode {
	...
	public MoniLoggerStreamAppenderNode(EPRuntime epRuntime, String eventType, MoniLoggerExecutableNode[] values) {
