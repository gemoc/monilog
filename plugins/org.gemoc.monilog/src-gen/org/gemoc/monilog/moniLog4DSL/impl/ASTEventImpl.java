 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.monilog.moniLog4DSL.impl.ASTEventImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.gemoc.monilog.moniLog4DSL.impl.ASTEventImpl#getRuleID <em>Rule ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ASTEventImpl extends EventImpl implements ASTEvent
{
  ...
  {
    return MoniLog4DSLPackage.Literals.AST_EVENT;
  }
  ...
  public NotificationChain basicSetKind(ASTEventKind newKind, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MoniLog4DSLPackage.AST_EVENT__KIND, oldKind, newKind);
  ...
  public void setKind(ASTEventKind newKind)
  {
    if (newKind != kind)
    {
      ...
      if (kind != null)
        msgs = ((InternalEObject)kind).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MoniLog4DSLPackage.AST_EVENT__KIND, null, msgs);
      if (newKind != null)
        msgs = ((InternalEObject)newKind).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MoniLog4DSLPackage.AST_EVENT__KIND, null, msgs);
      msgs = basicSetKind(newKind, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MoniLog4DSLPackage.AST_EVENT__KIND, newKind, newKind));
  }
  ...
  public void setRuleID(String newRuleID)
  {
    ...
    ruleID = newRuleID;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MoniLog4DSLPackage.AST_EVENT__RULE_ID, oldRuleID, ruleID));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MoniLog4DSLPackage.AST_EVENT__KIND:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MoniLog4DSLPackage.AST_EVENT__KIND:
        return getKind();
      case MoniLog4DSLPackage.AST_EVENT__RULE_ID:
        return getRuleID();
    }
