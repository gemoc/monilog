 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.monilog.moniLog4DSL.impl.AppenderCallImpl#getAppender <em>Appender</em>}</li>
 *   <li>{@link org.gemoc.monilog.moniLog4DSL.impl.AppenderCallImpl#getArgs <em>Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AppenderCallImpl extends ActionImpl implements AppenderCall
{
  ...
  {
    return MoniLog4DSLPackage.Literals.APPENDER_CALL;
  }
    ...
    if (appender != null && appender.eIsProxy())
    {
      ...
      if (appender != oldAppender)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MoniLog4DSLPackage.APPENDER_CALL__APPENDER, oldAppender, appender));
      }
    }
    return appender;
  }
  ...
  public void setAppender(Appender newAppender)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MoniLog4DSLPackage.APPENDER_CALL__APPENDER, oldAppender, appender));
  }
  ...
  public EList<CallArgument> getArgs()
  {
    if (args == null)
    {
      args = new EObjectContainmentEList<CallArgument>(CallArgument.class, this, MoniLog4DSLPackage.APPENDER_CALL__ARGS);
    }
    return args;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MoniLog4DSLPackage.APPENDER_CALL__ARGS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MoniLog4DSLPackage.APPENDER_CALL__APPENDER:
