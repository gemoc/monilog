 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.monilog.moniLog4DSL.impl.ComplexEventImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.gemoc.monilog.moniLog4DSL.impl.ComplexEventImpl#getPattern <em>Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexEventImpl extends EventImpl implements ComplexEvent
{
  ...
  {
    return MoniLog4DSLPackage.Literals.COMPLEX_EVENT;
  }
  ...
  public void setKind(TemporalPatternKind newKind)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MoniLog4DSLPackage.COMPLEX_EVENT__KIND, oldKind, kind));
  }
  ...
  public NotificationChain basicSetPattern(TemporalPattern newPattern, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MoniLog4DSLPackage.COMPLEX_EVENT__PATTERN, oldPattern, newPattern);
  ...
  public void setPattern(TemporalPattern newPattern)
  {
    if (newPattern != pattern)
    {
      ...
      if (pattern != null)
        msgs = ((InternalEObject)pattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MoniLog4DSLPackage.COMPLEX_EVENT__PATTERN, null, msgs);
      if (newPattern != null)
        msgs = ((InternalEObject)newPattern).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MoniLog4DSLPackage.COMPLEX_EVENT__PATTERN, null, msgs);
      msgs = basicSetPattern(newPattern, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MoniLog4DSLPackage.COMPLEX_EVENT__PATTERN, newPattern, newPattern));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MoniLog4DSLPackage.COMPLEX_EVENT__PATTERN:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MoniLog4DSLPackage.COMPLEX_EVENT__KIND:
        return getKind();
      case MoniLog4DSLPackage.COMPLEX_EVENT__PATTERN:
        return getPattern();
    }
