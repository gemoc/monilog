...
import org.gemoc.monilog.ide.contentassist.antlr.internal.InternalMoniLogParser;
import org.gemoc.monilog.services.MoniLogGrammarAccess;

public class MoniLogParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MoniLogGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MoniLogGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAtomicAccess().getAlternatives_2_1(), "rule__Atomic__Alternatives_2_1");
			...
			builder.put(grammarAccess.getMoniLogExpressionAccess().getGroup(), "rule__MoniLogExpression__Group__0");
			...
			builder.put(grammarAccess.getAtomicAccess().getGroup_4_3(), "rule__Atomic__Group_4_3__0");
			...
			builder.put(grammarAccess.getMoniLogExpressionAccess().getExpressionAssignment_1(), "rule__MoniLogExpression__ExpressionAssignment_1");
			...
			builder.put(grammarAccess.getAtomicAccess().getValueAssignment_2_1_0(), "rule__Atomic__ValueAssignment_2_1_0");
			builder.put(grammarAccess.getAtomicAccess().getValueAssignment_3_1(), "rule__Atomic__ValueAssignment_3_1");
			builder.put(grammarAccess.getAtomicAccess().getValuesAssignment_4_2(), "rule__Atomic__ValuesAssignment_4_2");
			builder.put(grammarAccess.getAtomicAccess().getValuesAssignment_4_3_1(), "rule__Atomic__ValuesAssignment_4_3_1");
			...
			builder.put(grammarAccess.getArraySizeAccess().getArrayAssignment_2(), "rule__ArraySize__ArrayAssignment_2");
	...
	@Override
	protected InternalMoniLogParser createParser() {
		InternalMoniLogParser result = new InternalMoniLogParser(null);
