...
public class EventSorter {
	...
	private static DirectedWeightedPseudograph<Event, DefaultWeightedEdge> createGraph(Collection<Event> events,
		...
		// event as child event to those events.
		...
		// For each monilogger emitting an user event, add the user event as child event
		// of the triggering event of the monilogger.
